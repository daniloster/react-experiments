...
:--- | :--- | :--- | :--- | :---
className|string|no|""|Outer world class to modify internal styles.
...
format|string|no|"DD MMM YYYY"|Date format e.g. &quot;DD/MM/YYYY&quot;.
...
value|number|yes||A utc timestamp.
calendar|arrayOf|yes||The calendar to display. It is an array of objects within start and end dates representing the week.
onClickItem|func|yes||Action to be associated as handler to click event on each date of the calendar.
-----
